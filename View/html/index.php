...
<body>
  ...
  <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +02 011 5459 8721</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> Galal@yahoo.com</a>
            </div>
          </div>
          <div class="col-sm-4 text-right text-sm">
            <div class="social-mini-button">
              <a href="https://www.facebook.com/galalsaad22"><span class="mai-logo-facebook-f"></span></a>
              <a href="https://www.instagram.com/galal_saad_1/"><span class="mai-logo-instagram"></span></a>
            </div>
          </div>
        </div> <!-- .row -->
      </div> <!-- .container -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="index.php"><span class="text-primary">patient</span>-Health</a>
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Chat</span> with a patientes</p>
            </div>
          </div>
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            ...
            <div class="body">
              <h5 class="post-title"><a href="blog-details.php">Recovery Room: News beyond the pandemic</a></h5>
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
                    <img src="../assets/img/person/person_1.jpg" alt="">
