...
$mail->Body    = "your Appointment date is ". $_POST['date']; " \n". "our Appointment time is " . $_POST['time']; 
$mail->send();
...
if(isset($_POST['name']) && isset($_POST['date']) && isset($_POST['time']) && isset($_POST['email']))
{
  ...
  if($controller->addAppointment($appointment))
  {
      ...
      $ret = mail($_POST['email'],"Examination reservation",$msg);
      echo "email sent successfuly to ".$_POST['email'];
     // $mas="records added successfully \n ".".email sent successfuly to".$_POST['email'];
      
    echo "<script>alert('records added successfullyS');</script>";
